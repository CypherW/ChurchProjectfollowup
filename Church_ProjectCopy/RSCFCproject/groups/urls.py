...
urlpatterns = [
    ...
    path('groups/display_attendance_feedback_required_modal/', views.display_attendance_feedback_required_modal, name='display_attendance_feedback_required_modal'),
    path('groups/display_attendance_feedback_last_week_required_modal/', views.display_attendance_feedback_last_week_required_modal, name='display_attendance_feedback_last_week_required_modal'),
    path('groups/display_attendance_feedback_two_weeks_ago_required_modal/', views.display_attendance_feedback_two_weeks_ago_required_modal, name='display_attendance_feedback_two_weeks_ago_required_modal'),
    path('groups/noFeedback_button_request_in_week/', views.noFeedback_button_request_in_week, name='noFeedback_button_request_in_week'),
